        ...
        <div className="footer__coffeshops">
          ...
          <div className='footer__coffeshopsBox'>
            <div className='footer__coffeshop'>
              <h4 className='footer__content footer__content_type_adres'>м Парк победы</h4>
              <h4 className='footer__content footer__content_type_adres'>Бассейная 12</h4>
              <p className='footer__content footer__content_type_adres'>Пн-Пт: 8:00-22:00</p>
              <p className='footer__content footer__content_type_adres'>Сб-Вс: 9:00-22:00</p>
            </div>
            <div className='footer__coffeshop'>
              <h4 className='footer__content footer__content_type_adres'>м Маяковская</h4>
              <h4 className='footer__content footer__content_type_adres'>Марата 2</h4>
              <p className='footer__content footer__content_type_adres'>Пн-Пт: 9:00-22:00</p>
              <p className='footer__content footer__content_type_adres'>Сб-Вс: 9:00-22:00</p>
            </div>
          </div>
        </div>
