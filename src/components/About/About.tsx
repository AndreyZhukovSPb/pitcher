  ...
  return (
    <section className='about'>
      ...
      <div className='about__container'>
        ...
        <div className='about__contextContainer'>
          <p className='about__context'>
            В основе нашего подхода к построению отношений с людьми лежит уважениеи забота.
          </p>
          <p className='about__context'>
      ...
      <div className='about__container'>
        ...
        <div className='about__contextContainer'>
          ...
          <p className='about__context'>
            если по стечению обстоятельств мы с вами еще не знакомы, то вы можете найти нас и отзывы гостей на всех популярных ресурсах, включая профессиональные. приходите, мы подружимся
          </p>
        </div>
