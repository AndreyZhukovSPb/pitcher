      ...
      <div className='stores__container'>
        ...
        <div className='stores__grid'>
          <Link to='/park' className='box1'>
            <img src={storesPictures[0]} alt="" className='stores__photo'/>
          </Link>
          <Link to='/park' className='box2'>
            <img src={storesPictures[1]} alt="" className='stores__photo'/>
          </Link>
          <a className='store__legend box6' href='/park'>м Парк Победы: улица Бассейная, 12</a>  
          <Link to='/mayak' className='box3'>
            <img src={storesPictures[2]} alt="" className='stores__photo'/>
          </Link>
          <Link to='/mayak' className='box4'>
            <img src={storesPictures[3]} alt="" className='stores__photo'/>
          </Link>
          <Link to='/mayak' className='box5'>
            <img src={storesPictures[4]} alt="" className='stores__photo'/>
          </Link>
